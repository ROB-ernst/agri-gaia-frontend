...
export default function ({
    ...
    const inference = async () => {
        ...
        httpPost(keycloak, `${TRITON_PATH}`, {models: selectedModels, datasets: datasetIds, url: url}, undefined, true)
            .then(({ headers }) => {
    ...
    return (
        <>
            <Dialog open={true} maxWidth="sm" fullWidth>
                ...
                <DialogActions>
                    <Button onClick={() => handleConfirmationResult(false)} color="primary">
                        Cancel
                    </Button>
                    <Button onClick={() => handleConfirmationResult(true)} color="secondary">
                        Confirm
                    </Button>
                </DialogActions>
            </Dialog>
